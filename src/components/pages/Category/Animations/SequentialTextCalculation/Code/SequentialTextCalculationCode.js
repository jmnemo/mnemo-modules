const SEQUENTIAL_TEXT_CALCULATION_CODE = (
...
class SequentialTextCalculation extends Component {
  ...
  getRandomValues = (remainingLength, result = '') => {
    ...
    if (remainingLength === 1) {
      return result + String.fromCharCode(this.getRandomNumber(minCharCode, maxCharCode));
    }

    return this.getRandomValues(
      remainingLength - 1,
      result + String.fromCharCode(this.getRandomNumber(minCharCode, maxCharCode))
    );
  }
...
export default SEQUENTIAL_TEXT_CALCULATION_CODE;